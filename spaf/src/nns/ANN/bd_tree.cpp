...
//		consecutively.)
//----------------------------------------------------------------------
const float BD_GAP_THRESH = (float) 0.5;		// gap threshold (must be < 1)
...
const float	BD_MAX_SPLIT_FAC = (float) 0.5;		// maximum number of splits allowed
const float	BD_FRACTION = (float) 0.5;			// ...to reduce points by this fraction
										// ...This must be < 1.
